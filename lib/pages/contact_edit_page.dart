...
class ContactEditPage extends StatefulWidget {
  ...
  ContactEditPage({super.key, required this.contactModel, required this.i});

  @override
  State<ContactEditPage> createState() => _ContactPageState();
}

class _ContactPageState extends State<ContactEditPage> {
  ...
  @override
  void initState() {
    file = File(widget.contactModel.path);
    ...
    phoneController = TextEditingController(text: widget.contactModel.number);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      await PathProviderService.updateContact(
